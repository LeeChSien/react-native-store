...
var Model = function () {
    ...
    _createClass(Model, [{
        ...
        key: 'multiAddOrUpdate',
        value: function () {
            var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee7(data, uniques) {
                var _this = this;

                var key, existingRowIndex, i, isFound, value, autoinc;
                    ...
                    while (1) {
                        switch (_context7.prev = _context7.next) {
                            ...
                            case 7:
                                ...
                                uniques.forEach(function (u_attr) {
                                    if (_this.model.rows[i][u_attr] != data[u_attr]) {
                                        isFound = false;
                                    }
                                });
                            ...
                            case 19:
                                ...
                                return _context7.abrupt('return', Util.error("ReactNativeStore error: Storage already contains _id '" + autoinc + "'"));
                            ...
                            case 23:
                                ...
                                return _context7.abrupt('return', Util.error("ReactNativeStore error: Don't need _id with add method"));
                            ...
                            case 33:
                                return _context7.abrupt('return', this.model.rows);
            ...
            function multiAddOrUpdate(_x3, _x4) {
                return ref.apply(this, arguments);
            }

            return multiAddOrUpdate;
        }()
        ...
        key: 'update',
        value: function () {
            var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee8(data, filter) {
                    ...
                    while (1) {
                        switch (_context8.prev = _context8.next) {
                            ...
                            case 2:
                                ...
                                _context8.t0 = regeneratorRuntime.keys(rows);
                            ...
                            case 8:
                                ...
                                row = _context8.t1.value;
                                _context8.t2 = regeneratorRuntime.keys(filterResult);
                            ...
                            case 23:
                                return _context8.abrupt('return', results.length ? results : null);
        ...
        key: 'updateById',
        value: function () {
            var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee9(data, id) {
                var result;
                    ...
                    while (1) {
                        switch (_context9.prev = _context9.next) {
                            ...
                            case 2:
                                ...
                                return _context9.abrupt('return', result ? result[0] : null);
        ...
        key: 'remove',
        value: function () {
            var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee10(filter) {
                ...
                return regeneratorRuntime.wrap(function _callee10$(_context10) {
                    while (1) {
                        switch (_context10.prev = _context10.next) {
                            ...
                            case 12:
                                return _context10.abrupt('return', results.length ? results : null);
                    ...
                    while (1) {
                        switch (_context11.prev = _context11.next) {
                            ...
                            case 2:
                                ...
                                return _context11.abrupt('return', result ? result[0] : null);
        ...
        key: 'find',
        value: function () {
            var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee12(filter) {
                var results, rows;
                    ...
                    while (1) {
                        switch (_context12.prev = _context12.next) {
                            ...
                            case 2:
                                ...
                                return _context12.abrupt('return', results.length ? results : null);
        ...
        key: 'findById',
        value: function () {
            var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee13(id) {
                var result;
                    ...
                    while (1) {
                        switch (_context13.prev = _context13.next) {
                            ...
                            case 2:
                                ...
                                return _context13.abrupt('return', result ? result[0] : null);
